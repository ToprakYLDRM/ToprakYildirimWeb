...
export const Contact: React.FC = () => {
    return (
        <section id="contact" className="py-16 md:py-24 px-4 md:px-8 lg:px-16 bg-primary text-white text-center">
            <div className="max-w-7xl mx-auto">
                <div className="max-w-3xl mx-auto py-8 md:py-12">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6">Ready to work together?</h2>
